		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-8 text-center mb-8"><br>
					<h2 class="heading-section">LOGIN COMMUNITY</h2>
				</div>
			</div>
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
					...
					<div class="login-wrap p-0">
						<center><h5 class="pertama">Have an account?</h5></center><br>
						<form action="<?php echo site_url('login/aksi_login_masyarakat')?>" class="signin-form" method	="post">
							...
							<form>
								<div class="form-group">
									<center><a class="txt" href="registrasi_masyarakat">Create your Account</a></center>
